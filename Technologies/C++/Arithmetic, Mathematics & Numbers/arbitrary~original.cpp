    ...
    class BigUnsignedInteger { template <size_t> friend class BigFloat; template <size_t> friend class BigSignedInteger; template <size_t> friend class BigUnsignedInteger; friend int main(void);
        ...
        public:
            ...
            // Definition > ...
                ...
                inline static BigUnsignedInteger<radix>& add(BigUnsignedInteger<radix> const& numberA, BigUnsignedInteger<radix>&& numberB) noexcept { return numberB.add(numberA); }
                ...
                inline static BigUnsignedInteger<radix>& add(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) noexcept { return numberA.add(numberB); }
                ...
                inline static BigUnsignedInteger<radix>& add(BigUnsignedInteger<radix>&& numberA, BigUnsignedInteger<radix> const& numberB) noexcept { return numberA.add(numberB); }

                BigUnsignedInteger<radix>& decrement(void) noexcept;
                inline static BigUnsignedInteger<radix>& decrement(BigUnsignedInteger<radix>& number) noexcept { return number.decrement(); }

                inline BigUnsignedInteger<radix>& divide(unsigned int const number) noexcept { return BigUnsignedInteger::divide((unsigned long) number); }
                inline BigUnsignedInteger<radix>& divide(unsigned long const number) noexcept { if (number ^ 1uL) BigUnsignedInteger::divide(BigUnsignedInteger<radix> {number}); return *this; }
                inline BigUnsignedInteger<radix>& divide(unsigned short const number) noexcept { return BigUnsignedInteger::divide((unsigned long) number); }
                BigUnsignedInteger<radix>& divide(BigUnsignedInteger<radix> const&) noexcept;
                inline static BigUnsignedInteger<radix> const divide(BigUnsignedInteger<radix> const& numberA, unsigned int const numberB) noexcept { return BigUnsignedInteger::divide(numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix> const divide(BigUnsignedInteger<radix> const& numberA, unsigned long const numberB) noexcept { BigUnsignedInteger<radix> evaluation {numberA}; evaluation.divide(numberB); return evaluation; }
                inline static BigUnsignedInteger<radix> const divide(BigUnsignedInteger<radix> const& numberA, unsigned short const numberB) noexcept { return BigUnsignedInteger::divide(numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix> const divide(BigUnsignedInteger<radix> const& numberA, BigUnsignedInteger<radix> const& numberB) noexcept { BigUnsignedInteger<radix> evaluation {numberA}; evaluation.divide(numberB); return evaluation; }
                inline static BigUnsignedInteger<radix>& divide(BigUnsignedInteger<radix>&& numberA, unsigned int const numberB) noexcept { return BigUnsignedInteger::divide((BigUnsignedInteger<radix>&&) numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix>& divide(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) noexcept { return numberA.divide(numberB); }
                inline static BigUnsignedInteger<radix>& divide(BigUnsignedInteger<radix>&& numberA, unsigned short const numberB) noexcept { return BigUnsignedInteger::divide((BigUnsignedInteger<radix>&&) numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix>& divide(BigUnsignedInteger<radix>&& numberA, BigUnsignedInteger<radix> const& numberB) noexcept { return numberA.divide(numberB); }
                ...
                inline static BigUnsignedInteger<radix>& increment(BigUnsignedInteger<radix>& number) noexcept { return number.increment(); }
                ...
                inline static BigUnsignedInteger<radix>& modulo(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) { return numberA.modulo(numberB); }
                ...
                BigUnsignedInteger<radix>& multiply(unsigned long const number) noexcept { if (number) { if (number ^ 1uL) { if (radix == 10u) { unsigned long evaluation = number; while (evaluation > 9uL && 0uL == evaluation % 10uL) evaluation /= 10uL; if (evaluation == 1uL) while (evaluation ^ number) { evaluation *= 10uL; BigUnsignedInteger::shiftLeft(); } else BigUnsignedInteger::multiply(BigUnsignedInteger<radix> {number}); } else BigUnsignedInteger::multiply(BigUnsignedInteger<radix> {number}); } } else { BigUnsignedInteger::zero(); } return *this; }
                ...
                inline static BigUnsignedInteger<radix>& multiply(BigUnsignedInteger<radix> const& numberA, BigUnsignedInteger<radix>&& numberB) noexcept { return numberB.multiply(numberA); }
                ...
                inline static BigUnsignedInteger<radix>& multiply(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) noexcept { return numberA.multiply(numberB); }
                ...
                inline static BigUnsignedInteger<radix>& multiply(BigUnsignedInteger<radix>&& numberA, BigUnsignedInteger<radix> const& numberB) noexcept { return numberA.multiply(numberB); }
                ...
                BigUnsignedInteger<radix>& shiftLeft(unsigned long const) noexcept;
                ...
                BigUnsignedInteger<radix>& shiftLeft(BigUnsignedInteger<radix> const&);
                inline static BigUnsignedInteger<radix>& shiftLeft(BigUnsignedInteger<radix>& number) noexcept { return number.shiftLeft(); }
                inline static BigUnsignedInteger<radix> const shiftLeft(BigUnsignedInteger<radix> const& numberA, unsigned int const numberB) noexcept { return BigUnsignedInteger::shiftLeft(numberA, (unsigned long) numberB); }
                ...
                inline static BigUnsignedInteger<radix> const shiftLeft(BigUnsignedInteger<radix> const& numberA, unsigned short const numberB) noexcept { return BigUnsignedInteger::shiftLeft(numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix> const shiftLeft(BigUnsignedInteger<radix> const& numberA, BigUnsignedInteger<radix> const& numberB) { BigUnsignedInteger<radix> evaluation {numberA}; evaluation.shiftLeft(numberB); return evaluation; }
                inline static BigUnsignedInteger<radix>& shiftLeft(BigUnsignedInteger<radix>&& numberA, unsigned int const numberB) noexcept { return BigUnsignedInteger::shiftLeft((BigUnsignedInteger<radix>&&) numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix>& shiftLeft(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) noexcept { return numberA.shiftLeft(numberB); }
                inline static BigUnsignedInteger<radix>& shiftLeft(BigUnsignedInteger<radix>&& numberA, unsigned short const numberB) noexcept { return BigUnsignedInteger::shiftLeft((BigUnsignedInteger<radix>&&) numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix>& shiftLeft(BigUnsignedInteger<radix>&& numberA, BigUnsignedInteger<radix> const& numberB) { return numberA.shiftLeft(numberB); }
                ...
                inline static BigUnsignedInteger<radix> const shiftRight(BigUnsignedInteger<radix> const& numberA, unsigned int const numberB) noexcept { return BigUnsignedInteger::shiftRight(numberA, (unsigned long) numberB); }
                ...
                inline static BigUnsignedInteger<radix> const shiftRight(BigUnsignedInteger<radix> const& numberA, unsigned short const numberB) noexcept { return BigUnsignedInteger::shiftRight(numberA, (unsigned long) numberB); }
                ...
                inline static BigUnsignedInteger<radix>& shiftRight(BigUnsignedInteger<radix>&& numberA, unsigned int const numberB) noexcept { return BigUnsignedInteger::shiftRight((BigUnsignedInteger<radix>&&) numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix>& shiftRight(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) noexcept { return numberA.shiftRight(numberB); }
                inline static BigUnsignedInteger<radix>& shiftRight(BigUnsignedInteger<radix>&& numberA, unsigned short const numberB) noexcept { return BigUnsignedInteger::shiftRight((BigUnsignedInteger<radix>&&) numberA, (unsigned long) numberB); }
                inline static BigUnsignedInteger<radix>& shiftRight(BigUnsignedInteger<radix>&& numberA, BigUnsignedInteger<radix> const& numberB) noexcept { return numberA.shiftRight(numberB); }
                ...
                inline static BigUnsignedInteger<radix>& subtract(BigUnsignedInteger<radix>&& numberA, unsigned long const numberB) noexcept { return numberA.subtract(numberB); }
                ...
                inline static BigUnsignedInteger<radix>& subtract(BigUnsignedInteger<radix>&& numberA, BigUnsignedInteger<radix> const& numberB) noexcept { return numberA.subtract(numberB); }
            ...
            inline BigUnsignedInteger<radix> const operator +(unsigned long const number) const& noexcept { return BigUnsignedInteger::add(*this, number); }
            ...
            inline BigUnsignedInteger<radix>& operator +(unsigned long const number)&& noexcept { return BigUnsignedInteger::add(number); }
            ...
            inline BigUnsignedInteger<radix> const operator *(unsigned int const number) const& noexcept { return BigUnsignedInteger::operator +((unsigned long) number); }
            inline BigUnsignedInteger<radix> const operator *(unsigned long const number) const& noexcept { return BigUnsignedInteger::multiply(*this, number); }
            inline BigUnsignedInteger<radix> const operator *(unsigned short const number) const& noexcept { return BigUnsignedInteger::operator +((unsigned long) number); }
            ...
            inline BigUnsignedInteger<radix>& operator *(unsigned int const number)&& noexcept { return BigUnsignedInteger::operator +((unsigned long) number); }
            inline BigUnsignedInteger<radix>& operator *(unsigned long const number)&& noexcept { return BigUnsignedInteger::multiply(number); }
            inline BigUnsignedInteger<radix>& operator *(unsigned short const number)&& noexcept { return BigUnsignedInteger::operator +((unsigned long) number); }
            ...
            inline BigUnsignedInteger<radix>& operator =(unsigned int const number) noexcept { return BigUnsignedInteger::operator =((unsigned long) number); }
           inline BigUnsignedInteger<radix>& operator =(unsigned long const number) noexcept { BigUnsignedInteger::copy(BigUnsignedInteger::fromInteger(number)); return *this; }
           inline BigUnsignedInteger<radix>& operator =(unsigned short const number) noexcept { return BigUnsignedInteger::operator =((unsigned long) number); }
    ...
    /* Big Unsigned Integer */
        ...
        inline BigUnsignedInteger<radix>& BigUnsignedInteger<radix>::add(BigUnsignedInteger<radix> const& number) noexcept {
            ...
            if (BigUnsignedInteger::isZero())
                ...
                // Logic
                if (BigUnsignedInteger::isBaseFactor(number) && this -> length < number.length) {
                    ...
                    ::memset(this -> value + 1, 0u, (number.length - this -> length - 1u) * sizeof(Digit));
                    *(this -> value) = 1u;
        ...
        template <size_t radix>
        inline BigUnsignedInteger<radix>& divide(BigUnsignedInteger<radix> const& number) noexcept {
            // Logic
            if (BigUnsignedInteger::isSignificant() && false == BigUnsignedInteger::isEqual(number, 1uL)) {
                ...
                else if (BigUnsignedInteger::isLesser(number))
                    // ...
                    BigUnsignedInteger::zero();

                else if (BigUnsignedInteger::isBaseFactor(number))
                    // ...
                    BigUnsignedInteger::shiftRight(number.length - 1u);

                else {
                    BigUnsignedInteger<radix> dividend;
                    Digit digit;
                    BigUnsignedInteger<radix> quotient;

                    dividend.length = number.length;
                    dividend.value = this -> value;

                    quotient.allocate(this -> length);

                    while (BigUnsignedInteger::isLesser(dividend, number)) ++dividend.length;

                    // COUNT UP NUMBER TO BE DIVIDEND
                    // PUSH COUNT TO QUOTIENT
                    // IF DIVIDEND IS UPDATE-ABLE, UPDATE DIVIDEND; OTHERWISE FINISH

                    BigUnsignedInteger::copy(quotient);
                }
            }
        ...
        template <size_t radix>
        inline BigUnsignedInteger<radix>& BigUnsignedInteger<radix>::exponentiate(BigUnsignedInteger<radix> const& number) noexcept {
            // ...
            (void) number;
        ...
        BigUnsignedInteger<radix>& BigUnsignedInteger<radix>::multiply(BigUnsignedInteger<radix> const& number) noexcept {
            ...
            if (BigUnsignedInteger::isSignificant() && false == BigUnsignedInteger::isEqual(number, 1uL)) {
                ...
                if (BigUnsignedInteger::isZero(number))
                ...
                else if (number.length == 1u) { // NOTE (Lapys) -> More-or-less copied from the following `else` control block.
                    // Initialization > (Carry, Digit)
                    Digit carry;
                    ...
                    for (size_t iterator = 0u; iterator ^ (this -> length); ++iterator) {
                        // Initialization > Evaluation
                        Digit *evaluation = (Digit*) Digit::multiply<radix>(digit, *(this -> value + (this -> length - iterator - 1u)));
                        ...
                        *(this -> value + (this -> length - iterator - 1u)) = *(evaluation + 1);
        ...
        template <size_t radix>
        inline BigUnsignedInteger<radix>& BigUnsignedInteger<radix>::shiftLeft(unsigned long const number) noexcept {
            // Logic
        ...
        template <size_t radix>
        inline BigUnsignedInteger<radix>& BigUnsignedInteger<radix>::shiftLeft(BigUnsignedInteger<radix> const& number) {
            // Logic
            if (BigUnsignedInteger::isSignificant() && BigUnsignedInteger::isSignificant(number)) {
                // Logic > ...
                if (BigUnsignedInteger::isBig(number)) throw std::overflow_error("Attempt to shift left caused overflow");
                else BigUnsignedInteger::shiftLeft(BigUnsignedInteger::toInteger(number));
            }
            ...
            if (BigUnsignedInteger::isSignificant(number)) {
                ...
                if (base == radix)
                    ...
                    *evaluation.value = 1u;
                    ...
                    for (count = 0u; BigUnsignedInteger::isLesser(exponent, number); ++count) exponent.multiply(base);

                    if (BigUnsignedInteger::isEqual(exponent, number))
                        for (iterator = 0u; count ^ iterator; ++iterator) evaluation.shiftLeft();

                    else {
                        for (iterator = 1u; count ^ iterator; ++iterator) evaluation.shiftLeft();

                        exponent.divide(base);
                        for (count = 0u; BigUnsignedInteger::isLesser(exponent, number); ++count) exponent.add(base);

                        if (BigUnsignedInteger::isEqual(exponent, number))
                        for (iterator = 0u; count ^ iterator; ++iterator) evaluation.add(base);

                        else {
                            exponent.subtract(base);
                            for (iterator = 1u; count ^ iterator; ++iterator) evaluation.add(base);
...
int main(void) {
    ...
    /* [Update] ... */ {
        // ::println("[EVAL]: ", BigUnsignedInteger<10u>::toBase<2u>(BigUnsignedInteger<10u> {64u}).toString());
        ::println("[EVAL]: ", BigUnsignedInteger<10u>::toBase<2u>(BigUnsignedInteger<10u> {78u}).toString());
