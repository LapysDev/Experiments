...
/* Class > Big Number --- NOTE (Lapys) -> Arbitrary-precision natural-base numbers; code applies similarly for other bases. */
class BigNumber {
    // ...
    ...
    private:
        ...
        size_t characteristicsLength; // NOTE (Lapys) -> Number of digits in integer part; May infer `0` without the `value` member containing significant data (i.e.: being `NULL`).
        size_t mantissaLength; // NOTE (Lapys) -> Number of digits in fractional part.
        bool signedness; // NOTE (Lapys) -> Additive representative.
        enum BigNumberState {DENORMALIZED, INFINITE, SAFE, UNCOMPUTABLE} state; // NOTE (Lapys) -> Computational representative.
        char *value; // NOTE (Lapys) -> Keep the characteristics and mantissa digit strings co-joined as the same field.
                     //     Normally this value would be a store of unique types (i.e.: a digit type) but the primitive character type (`char`) is sufficient.
        ...
        // : NOTE (Lapys) -> Request more storage memory for the `value` data field to store (in)valid digits.
        ...
        // : NOTE (Lapys) -> Copy another `BigNumber` object.
        ...
        // : NOTE (Lapys) -> Request the next successive dynamic memory byte size for the `value` data field; The growth rate is the Fibonacci sequence (a rate of `1.5` is also acceptable).
    ...
    protected:
        // Function > ... --- MINIFY (Lapys)
        // : NOTE (Lapys) -> Atomic digit-by-digit arithmetic evaluations and/ or operations; It is assumed digits are inflexible, non-contiguous, singular values.
        inline static char const* add(char const digitA, char const digitB) noexcept { static char evaluation[3] {0}; if (BigNumber::isEqual(digitA, '0')) { *evaluation = digitB; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '0')) { *evaluation = digitA; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitA, '1')) ::strncpy(evaluation, BigNumber::increment(digitB), 2u); else if (BigNumber::isEqual(digitB, '1')) ::strncpy(evaluation, BigNumber::increment(digitA), 2u); else { if (BigNumber::isEqual(digitA, '2')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '4'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '5'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '6'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '7'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '8'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '9'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '1'; } } else if (BigNumber::isEqual(digitA, '3')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '5'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '6'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '7'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '8'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '9'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '2'; } } else if (BigNumber::isEqual(digitA, '4')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '6'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '7'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '8'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '9'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '2'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '3'; } } else if (BigNumber::isEqual(digitA, '5')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '7'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '8'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '9'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '2'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '3'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '4'; } } else if (BigNumber::isEqual(digitA, '6')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '8'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '9'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '1'; *(evaluation + 1) = '2'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '3'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '4'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '5'; } } else if (BigNumber::isEqual(digitA, '7')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '9'; *(evaluation + 1) = '\0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '1'; *(evaluation + 1) = '2'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '1'; *(evaluation + 1) = '3'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '4'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '5'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '6'; } } else if (BigNumber::isEqual(digitA, '8')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '1'; *(evaluation + 1) = '0'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '1'; *(evaluation + 1) = '2'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '1'; *(evaluation + 1) = '3'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '1'; *(evaluation + 1) = '4'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '5'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '6'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '7'; } } else if (BigNumber::isEqual(digitA, '9')) { if (BigNumber::isEqual(digitB, '2')) { *evaluation = '1'; *(evaluation + 1) = '1'; } else if (BigNumber::isEqual(digitB, '3')) { *evaluation = '1'; *(evaluation + 1) = '2'; } else if (BigNumber::isEqual(digitB, '4')) { *evaluation = '1'; *(evaluation + 1) = '3'; } else if (BigNumber::isEqual(digitB, '5')) { *evaluation = '1'; *(evaluation + 1) = '4'; } else if (BigNumber::isEqual(digitB, '6')) { *evaluation = '1'; *(evaluation + 1) = '5'; } else if (BigNumber::isEqual(digitB, '7')) { *evaluation = '1'; *(evaluation + 1) = '6'; } else if (BigNumber::isEqual(digitB, '8')) { *evaluation = '1'; *(evaluation + 1) = '7'; } else if (BigNumber::isEqual(digitB, '9')) { *evaluation = '1'; *(evaluation + 1) = '8'; } } } return &*evaluation; }

        inline static char const* decrement(char const digit) noexcept { static char evaluation[3] {0}; switch (digit) { case '0': *evaluation = '-'; *(evaluation + 1) = '1'; break; case '1': *evaluation = '0'; *(evaluation + 1) = '\0'; break; case '2': *evaluation = '1'; *(evaluation + 1) = '\0'; break; case '3': *evaluation = '2'; *(evaluation + 1) = '\0'; break; case '4': *evaluation = '3'; *(evaluation + 1) = '\0'; break; case '5': *evaluation = '4'; *(evaluation + 1) = '\0'; break; case '6': *evaluation = '5'; *(evaluation + 1) = '\0'; break; case '7': *evaluation = '6'; *(evaluation + 1) = '\0'; break; case '8': *evaluation = '7'; *(evaluation + 1) = '\0'; break; case '9': *evaluation = '8'; *(evaluation + 1) = '\0'; break; } return &*evaluation; }
        inline static char const* increment(char const digit) noexcept { static char evaluation[3] {0}; switch (digit) { case '0': *evaluation = '1'; *(evaluation + 1) = '\0'; break; case '1': *evaluation = '2'; *(evaluation + 1) = '\0'; break; case '2': *evaluation = '3'; *(evaluation + 1) = '\0'; break; case '3': *evaluation = '4'; *(evaluation + 1) = '\0'; break; case '4': *evaluation = '5'; *(evaluation + 1) = '\0'; break; case '5': *evaluation = '6'; *(evaluation + 1) = '\0'; break; case '6': *evaluation = '7'; *(evaluation + 1) = '\0'; break; case '7': *evaluation = '8'; *(evaluation + 1) = '\0'; break; case '8': *evaluation = '9'; *(evaluation + 1) = '\0'; break; case '9': *evaluation = '1'; *(evaluation + 1) = '0'; break; } return &*evaluation; }
        ...
        // : NOTE (Lapys) -> Utility helper procedures.
        inline bool characteristicsIsEqual(char const number) const noexcept { if ('0' == number) return this -> characteristicsLength == 1u ? '0' == *(this -> value) : 0u == this -> characteristicsLength; else return this -> characteristicsLength == 1u && number == *(this -> value); }
        inline bool characteristicsIsEqual(char const* const number, size_t const length) const noexcept { return NULL != this -> value && 0 == ::strncmp(this -> value, number, length); }
        template <typename... types> inline static bool characteristicsIsEqual(BigNumber const& number, types... arguments) noexcept { return number.characteristicsIsEqual(arguments...); }
        template <typename... types> inline static bool characteristicsIsEqual(BigNumber&& number, types... arguments) noexcept { return number.characteristicsIsEqual(arguments...); }

        inline bool mantissaIsEqual(char const number) const noexcept { return this -> mantissaLength == 1u && number == *(this -> value + this -> characteristicsLength); }
        inline bool mantissaIsEqual(char const* const number, size_t const length) const noexcept { return NULL != this -> value && 0 == ::strncmp(this -> value + (this -> characteristicsLength), number, length); }
        template <typename... types> inline static bool mantissaIsEqual(BigNumber const& number, types... arguments) noexcept { return number.mantissaIsEqual(arguments...); }
        template <typename... types> inline static bool mantissaIsEqual(BigNumber&& number, types... arguments) noexcept { return number.mantissaIsEqual(arguments...); }
    ...
    public:
        ...
        inline static bool isBaseFactor(BigNumber const& number) noexcept { return number.isBaseFactor(); }
        inline static bool isBaseFactor(BigNumber&& number) noexcept { return BigNumber::isBaseFactor(number); }
        ...
        inline static bool isInteger(BigNumber const& number) noexcept { return number.isInteger(); }
        inline static bool isInteger(BigNumber&& number) noexcept { return BigNumber::isInteger(number); }
        ...
        inline static bool isSignificant(BigNumber const& number) noexcept { return number.isSignificant(); }
        inline static bool isSignificant(BigNumber&& number) noexcept { return BigNumber::isSignificant(number); }
        ...
        BigNumber& logarithmize(...) noexcept;
        ...
        inline static BigNumber const reciprocate(BigNumber&& number) noexcept { number.reciprocate(); return number; }

        void shiftLeft(void) noexcept;
        ...
        inline static BigNumber const sign(BigNumber&& number) noexcept { number.sign(); return number; }
        ...
        inline static BigNumber const unsign(BigNumber&& number) noexcept { number.unsign(); return number; }
...
/* Modification > Big Number
        --- NOTE ---
            #Lapys:
                - The first (destination) operand will be assumed to be the symbol `x` and the second (source) `y`.
                - The mantissa of the first (destination) operand will be assumed to be the symbol `a` and the second (source) `b`, while their characteristics will remain as their whole representation (i.e.: `x` and `y`).
                - The common radix will be assumed to be the variable `z`.

        --- WARN (Lapys) -> Each operation may begin with the `value` data member still set to `NULL`.
*/
    // Add --> `x + y`.
    BigNumber& BigNumber::add(BigNumber const& number) noexcept {
        ...
        if (BigNumber::isSafe()) {
            // Logic
            if (BigNumber::isInfinite(number) || BigNumber::isNaN(number)) // --> y is not computable
                // ....
                BigNumber::copy(number);

            else if (false == BigNumber::isZero(number)) {
                // Logic
                if (BigNumber::isZero()) // --> 0 + y
                    // ...
                    BigNumber::copy(number);

                else {
                    // Logic
                    if (BigNumber::characteristicsIsEqual(number, '1') && BigNumber::isInteger(number)) // --> x + 1 or x + -1
                        // ...
                        BigNumber::isNegative() ? BigNumber::decrement() : BigNumber::increment();

                    else if (BigNumber::isNegative() && BigNumber::isPositive(number)) // --> -x + y
                        // ...
                        BigNumber::copy(BigNumber::subtract(number, *this));

                    else if (BigNumber::isPositive() && BigNumber::isNegative(number)) // --> x + -y
                        // ...
                        BigNumber::subtract(number);
                        ...
                        // Logic --- NOTE (Lapys) -> Compute the mantissas.
                        if (BigNumber::hasSignificantMantissa(number)) {
                            // Logic
                            if (BigNumber::hasSignificantMantissa()) { // .a + .b
                                // Logic --- NOTE (Lapys) -> Zero-pad the destination mantissa. --> x.a00 + y.bbb
                        ...
                        // Logic --- NOTE (Lapys) -> Consider the mantissa-characteristics overflow from the previous parse.
                        if (carry) {
                            // ...
                            BigNumber::isNegative() ? BigNumber::decrement() : BigNumber::increment();
                            carry = false;
                        ...
                        // Logic --- NOTE (Lapys) -> Compute the characteristics.
                        if (BigNumber::hasSignificantCharacteristics(number)) {
                            // Logic
                            if (BigNumber::hasSignificantCharacteristics()) { // x + y
                                // Logic --- NOTE (Lapys) -> Zero-pad the destination characteristics --> 00x + yyy.
                                ...
                                for (size_t iterator = 0u; iterator ^ (this -> characteristicsLength); ++iterator) {
                                    // Initialization > Evaluation
                                    char *evaluation = (char*) BigNumber::add(*--iteratorA, BigNumber::isEqual(*(this -> value), '0') ? *--iteratorB : (iterator < number.characteristicsLength ? *--iteratorB : '0'));
                        ...
                        // Logic --- NOTE (Lapys) -> Consider the final overflow from the previous parse.
                        if (carry) {
                            // Modification > Target > (Characteristics Length, Value)
    ...
    BigNumber& BigNumber::decrement(void) noexcept {
        ...
        if (BigNumber::isSafe()) {
            // ...
            BigNumber::allocate(this -> characteristicsLength + this -> mantissaLength);

            // Logic
            if (false == BigNumber::hasSignificantCharacteristics()) { // --> x.a where x is 0
                // Logic
                if (BigNumber::hasSignificantMantissa()) { // --> x.a where a is not 0
                ...
                // Logic > ...
                if (BigNumber::isPositive()) BigNumber::sign();
                ...
                *(this -> value) = '1';
            ...
            else if (BigNumber::isNegative()) { // --> -x - 1 = -(x + 1)
                // ...
                BigNumber::unsign();
                BigNumber::increment();
                BigNumber::sign();
                ...
                while (BigNumber::isEqual(*--iterator, '0')) *iterator = '9';

                // Logic
                if (BigNumber::isEqual(*iterator, '1') && iterator == this -> value) {
                    // Modification > Target > (Characteristics Length)
                    --(this -> characteristicsLength);
    ...
    // Get Characteristics
    inline long double BigNumber::getCharacteristics(void) const {
        // Evaluation > Evaluation
        long double evaluation = 0.00L;

        // Logic
        if (BigNumber::isComputable()) {
            // Logic
            if (BigNumber::isInfinite())
                // Update > Evaluation
                evaluation = INFINITY;

            else if (this -> characteristicsLength) {
                // Initialization > Exponent; Loop
                long double exponent = 1.00L;
                for (char *iterator = this -> value + (this -> characteristicsLength); iterator != (this -> value); ) {
                    // Update > (Evaluation, ...)
                    evaluation += BigNumber::toNumber(*--iterator) * exponent;
                    exponent *= 10.00L;
                }
            }

            // Logic > Update > Evaluation
            if (BigNumber::isNegative()) evaluation = -evaluation;
        }
    ...
    // Get Mantissa
    inline long double BigNumber::getMantissa(void) const {
        // Evaluation > Evaluation
        long double evaluation = 0.00L;
        ...
        if (BigNumber::isComputable()) {
            ...
            if (BigNumber::isInfinite())
                ...
                // Initialization > Exponent; Loop
                long double exponent = 10.00L;
                for (size_t iterator = 0u; iterator ^ (this -> mantissaLength); ++iterator) {
                    // Update > (Evaluation, ...)
                    evaluation += BigNumber::toNumber(*((this -> value + (this -> characteristicsLength)) + iterator)) / exponent;
                    exponent *= 10.00L;
                }
            }
    ...
    // Has Significant Characteristics --- NOTE (Lapys) -> Equivalent to `false == BigNumber::characteristicsIsEqual('0')`. --> x.a where x is not 0
    ...
    // Has Significant Mantissa --- NOTE (Lapys) -> Equivalent to `false == BigNumber::mantissaIsEqual('0')`. --> x.a where a is not 0.
        ...
        if (BigNumber::isSafe()) {
            ...
            if (false == BigNumber::hasSignificantCharacteristics()) { // --> x.a where x is 0
                ...
                *(this -> value) = '1';
                ...
                // Loop > Update > Iterator
                while (BigNumber::isEqual(*--iterator, '9')) *iterator = '0';

                // Logic
                if (iterator == this -> value - 1) { // NOTE (Lapys) -> Consider overflow.
                    // ...
                    BigNumber::allocate(this -> characteristicsLength + this -> mantissaLength + 1u);
    ...
    // Is Base Factor --- NOTE (Lapys) -> Assert the number is a factor of its natural base (or radix), which is `10` by default.
    inline bool BigNumber::isBaseFactor(void) const noexcept {
        // Initialization > Evaluation
        bool evaluation = BigNumber::isInteger() && (this -> characteristicsLength >= 2u && BigNumber::isEqual(*(this -> value), '1'));

        // Logic
        if (evaluation) {
            // Loop > Logic > Update > Evaluation
            for (size_t iterator = 1u; evaluation && (iterator ^ (this -> characteristicsLength)); ++iterator)
            if (false == BigNumber::isEqual(*(this -> value + iterator), '0')) evaluation = false;
        }
    ...
    bool BigNumber::isEqual(BigNumber const& numberA, BigNumber const& numberB) noexcept {
        ...
        if (BigNumber::isSafe(numberA) && BigNumber::isSafe(numberB)) {
            // Logic
            if (BigNumber::isZero(numberA)) // --> 0 = y
                // Update > Evaluation
                evaluation = BigNumber::isZero(numberB);

            else if (BigNumber::isZero(numberB)) // --> x = 0
                // Update > Evaluation
                evaluation = BigNumber::isZero(numberA);

            else if (( // x.a = y.b where a, b, x and y are not 0
            ...
            ) && ( // x = y where x and y are of equal magnitude
                (BigNumber::isNegative(numberA) && BigNumber::isNegative(numberB)) ||
                (BigNumber::isPositive(numberA) && BigNumber::isPositive(numberB))
            )) {
                // Logic
                if (0u == numberA.characteristicsLength) // 0.a = y.b
                    // Update > Evaluation
                    evaluation = false == BigNumber::hasSignificantCharacteristics(numberB);

                else if (0u == numberB.characteristicsLength) // x.a = 0.b
                    // Update > Evaluation
                    evaluation = false == BigNumber::hasSignificantCharacteristics(numberA);

                else if (numberA.characteristicsLength ^ numberB.characteristicsLength) // xx is not yyy
                    // Update > Evaluation
                    evaluation = false;
    ...
    // Is Integer --- NOTE (Lapys) -> Similar to `false == BigNumber::hasSignificantMantissa()`.
    inline bool BigNumber::isInteger(void) const noexcept { return 0u == this -> mantissaLength; }
    ...
    // Is Significant
    inline bool BigNumber::isSignificant(void) const noexcept { return this -> characteristicsLength || this -> mantissaLength; }

    // Is Zero --- NOTE (Lapys) -> Equivalent to `BigNumber::characteristicsIsEqual('0')`. --> x.a where x is 0
    ...
    BigNumber& BigNumber::logarithmize(...) noexcept { return *this; }
    ...
    BigNumber& BigNumber::multiply(BigNumber const& number) noexcept {
        ...
        if (BigNumber::isInfinite()) {
            ...
            // Logic
            if (BigNumber::isZero() || BigNumber::isZero(number)) { // --> 0 × y or x × 0
                // ...
                BigNumber::unsign();
            ...
            else if (false == BigNumber::characteristicsIsEqual(number, '1')) { // --> x × y where y is not 1
                // Logic
                if (BigNumber::characteristicsIsEqual('1') && BigNumber::isInteger()) // --> 1 × y
                    // ...
                    BigNumber::copy(number);

                else if (BigNumber::isBaseFactor()) { // NOTE (Lapys) -> Optimize for a denary-based number system. --> x × y where x is a factor of z
                    char *iterator = this -> value;
                    bool const signedness = BigNumber::isNegative();

                    std::cout << "[DEBUG]" << std::endl;

                    while ('0' == *++iterator) continue;

                    BigNumber::copy(number);
                    BigNumber::unsign();

                    while (iterator-- != this -> value) BigNumber::shiftLeft();

                    if (signedness) BigNumber::sign();
                    if (BigNumber::isNegative(number)) BigNumber::sign();
                }

                else if (BigNumber::isBaseFactor(number)) { // --> x × y where y is a factor of z
                }

                else if (BigNumber::isSignificant(number)) { // x × y
                    // Initialization > ...
    ...
    inline void BigNumber::reciprocate(void) noexcept {
        ...
        if (BigNumber::isComputable() || BigNumber::isFinite()) {
            if (BigNumber::isZero()) this -> state = BigNumber::INFINITE;
            else if (false == (BigNumber::isInteger() && (this -> characteristicsLength == 1u && '1' == *(this -> value)))) {
                while (this -> mantissaLength) { ++(this -> characteristicsLength); --(this -> mantissaLength); }
            }
        }
    }

    // Sign --> -x.
    inline void BigNumber::sign(void) noexcept { this -> signedness = !(this -> signedness); }
                ...
                if (BigNumber::isPositive() && BigNumber::isNegative(number))
                    ...
                    for (size_t iterator = 0u, length = this -> characteristicsLength + this -> mantissaLength; (iterator ^ length) && (iteratorB != number.value); ) {
                        ...
                        if ('-' == *evaluation) {
                            ...
                            while (BigNumber::isEqual(*--subiterator, '0')) *subiterator = '9';
                            *subiterator = *BigNumber::decrement(*subiterator);
                        } else { *iteratorA = *evaluation; ++iterator; }
                    }

                    // Loop > Modification > Target > Mantissa Length
                    while (this -> mantissaLength && BigNumber::isEqual(*(this -> value + ((this -> characteristicsLength + this -> mantissaLength) - 1u)), '0'))
                    --(this -> mantissaLength);

                    // Logic
                    if (this -> characteristicsLength && BigNumber::isEqual(*(this -> value), '0')) {
                        // Initialization > Iterator
                        char *iterator = this -> value;

                        // Loop > Modification > Target > (Characteristics Length, ...)
                        while (this -> characteristicsLength && BigNumber::isEqual(*iterator++, '0')) --(this -> characteristicsLength);
    ...
    // To Number
    inline long double BigNumber::toNumber(BigNumber const& number) { return BigNumber::getCharacteristics(number) + BigNumber::getMantissa(number); }
...
/* Main */
int main(void) {
    // Initialization > (Randomizer, Stream)
    std::uniform_int_distribution<std::mt19937::result_type> randomizer(1u, 100000u);
    std::mt19937 randomNumberGenerator(std::random_device{} ()); // -> randomizer(randomNumberGenerator)
    std::ostream& stream = std::cout; // NOTE (Lapys) -> Output stream. --> (Lapys) -> stream << ... | stream.put(...) | stream.write(..., x);

    /* [Initiate] ... */
    stream.write("[PROGRAM INITIATED]", 19u); std::endl(stream);

    /* [Update] ... */ {
    }

    /* [Terminate] ... */
    stream.write("[PROGRAM TERMINATED]", 20u); std::flush(stream);
