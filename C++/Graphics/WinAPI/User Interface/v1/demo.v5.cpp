...
/* Functions */
    ...
    */
    void AddControls(HWND hWnd) {
        ...
        // Create Window
        CreateWindowW(L"button", L"Change Window Title", WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 80, 175, 25, hWnd, (HMENU) CHANGE_WINDOW_TITLE, NULL, NULL);
    };
    ...
    void AddMenus(HWND hWnd) {
        ...
        */
            ...
            AppendMenu(hMenu, MF_POPUP, (UINT_PTR) hFileMenu, "File");
                ...
                // Open
                AppendMenu(hFileMenu, MF_POPUP, (UINT_PTR) hWindowTitleChangeMenu, "Options");
                    // Change Window Title
