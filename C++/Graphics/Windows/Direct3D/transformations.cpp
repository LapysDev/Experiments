...
constexpr vertex_t TRIANGLE[3] = {
    {2.5f, -2.5f, 0.0f, D3DCOLOR_XRGB(0x00u, 0x00u, 0xFFu)},
    {0.0f, 2.5f, 0.0f, D3DCOLOR_XRGB(0x00u, 0xFFu, 0x00u)},
    {-2.5f, -2.5f, 0.0f, D3DCOLOR_XRGB(0xFFu, 0x00u, 0x00u)}
};
...
void Update(void) { // NOTE (Lapys) ->
    ...
    /* [Update] Render to the back buffer. */ {
        ...
        ::D3DXMatrixRotationY(&MATRIX_TRANSFORMATIONS.worldYRotation, angle += 0.0174533f);
...
int WinMain(HINSTANCE const instanceHandle, HINSTANCE const, LPSTR const, int const appearance) {
    ...
    if (0x0 == ::RegisterClassEx((WNDCLASSEX const*) &windowClassInformation)) exitCode = EXIT_FAILURE;
        ...
        windowHandle = ::CreateWindowEx(
            0x0, windowClassInformation.lpszClassName, "Direct 3D | Transformations", WS_OVERLAPPEDWINDOW,
