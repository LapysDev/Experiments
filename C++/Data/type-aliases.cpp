...
namespace std {
  ...
  template <typename> struct base_of_t final {};
  ...
  struct member_type<false, object_t, member_t> : public member_t {
    ...
    public:
      ...
      constexpr inline member_t& valueOf(void) noexcept { return *this; }
  ...
  struct member_type<true, object_t, member_t> {
    ...
    public:
      ...
      constexpr inline member_t& valueOf(void) noexcept { return this -> value; }
    ...
    struct immutable_accessor final : public std::member_type<std::is_base<member_t>::value || std::is_final<member_t>::value, object_t, member_t> { friend object_t;
      public:
        ...
        template <typename = member_t> constexpr immutable_accessor operator -(void) const noexcept { return -(this -> valueOf()); }
        template <typename type = member_t> constexpr typename std::base_of_t<type>::type& operator *(void) const noexcept { return const_cast<typename std::base_of_t<type>::type&>(*(this -> valueOf())); }
        template <typename type = member_t> inline immutable_accessor& operator =(type const& value) { this -> valueOf() = value; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator +=(type const& value) { this -> valueOf() += value; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator -=(type const& value) { this -> valueOf() -= value; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator *=(type const& value) { this -> valueOf() *= value; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator /=(type const& value) { this -> valueOf() /= value; return *this; }
        ...
        template <typename type = member_t> inline immutable_accessor& operator <<=(type const& value) { this -> valueOf() <<= value; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator >>=(type const& value) { this -> valueOf() >>= value; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator ++(void) { ++(this -> valueOf()); return *this; }
        template <typename type = member_t> inline immutable_accessor& operator ++(int const) { (this -> valueOf())++; return *this; }
        template <typename type = member_t> inline immutable_accessor& operator --(void) { --(this -> valueOf()); return *this; }
        template <typename type = member_t> inline immutable_accessor& operator --(int const) { (this -> valueOf())--; return *this; }
        template <typename index_t, typename type = member_t> constexpr typename std::enable_if<std::is_array_pointer<type>::value, typename std::base_of_t<type>::type&>::type operator [](index_t const& index) const noexcept { return const_cast<typename std::base_of_t<type>::type&>((*(this -> valueOf()))[index]); }
        template <typename index_t, typename type = member_t> constexpr typename std::enable_if<std::is_array<type>::value || std::is_array_reference<type>::value, typename std::base_of_t<type>::type&>::type operator [](index_t const& index) const noexcept { return const_cast<typename std::base_of_t<type>::type&>(this -> valueOf()[index]); }
