...
struct $shorthand {
  private:
    ...
    struct operation_information final {
      ...
      // ...
      template <typename base> struct address           <decltype(static_cast<void>(&instanceof<base>())),              base> final { static bool const value = true; constexpr static decltype(&std::declval<base>())              valueof(base&& operand) noexcept(noexcept(&instanceof<base>()))              { return &std::forward<base>(operand);              } };
      template <typename base> struct complement        <decltype(static_cast<void>(~instanceof<base>())),              base> final { static bool const value = true; constexpr static decltype(~std::declval<base>())              valueof(base&& operand) noexcept(noexcept(~instanceof<base>()))              { return ~std::forward<base>(operand);              } };
      template <typename base> struct dereference       <decltype(static_cast<void>(*instanceof<base>())),              base> final { static bool const value = true; constexpr static decltype(*std::declval<base>())              valueof(base&& operand) noexcept(noexcept(*instanceof<base>()))              { return *std::forward<base>(operand);              } };
      template <typename base> struct destruct          <decltype(static_cast<void>(instanceof<base>().~base())),       base> final { static bool const value = true; constexpr static decltype(std::declval<base>().~base())       valueof(base&& operand) noexcept(noexcept(instanceof<base>().~base()))       { return std::forward<base>(operand).~base();       } };
      template <typename base> struct member_access     <decltype(static_cast<void>(instanceof<base>().operator ->())), base> final { static bool const value = true; constexpr static decltype(std::declval<base>().operator ->()) valueof(base&& operand) noexcept(noexcept(instanceof<base>().operator ->())) { return std::forward<base>(operand).operator ->(); } };
      template <typename base> struct minus             <decltype(static_cast<void>(-instanceof<base>())),              base> final { static bool const value = true; constexpr static decltype(-std::declval<base>())              valueof(base&& operand) noexcept(noexcept(-instanceof<base>()))              { return -std::forward<base>(operand);              } };
      template <typename base> struct negate            <decltype(static_cast<void>(!instanceof<base>())),              base> final { static bool const value = true; constexpr static decltype(!std::declval<base>())              valueof(base&& operand) noexcept(noexcept(!instanceof<base>()))              { return !std::forward<base>(operand);              } };
      template <typename base> struct overloaded_address<decltype(static_cast<void>(instanceof<base>().operator &())),  base> final { static bool const value = true; constexpr static decltype(std::declval<base>().operator &())  valueof(base&& operand) noexcept(noexcept(instanceof<base>().operator &()))  { return std::forward<base>(operand).operator &();  } };
      template <typename base> struct plus              <decltype(static_cast<void>(+instanceof<base>())),              base> final { static bool const value = true; constexpr static decltype(+std::declval<base>())              valueof(base&& operand) noexcept(noexcept(+instanceof<base>()))              { return +std::forward<base>(operand);              } };
      template <typename base> struct post_decrement    <decltype(static_cast<void>(instanceof<base>()--)),             base> final { static bool const value = true; constexpr static decltype(std::declval<base>()--)             valueof(base&& operand) noexcept(noexcept(instanceof<base>()--))             { return std::forward<base>(operand)--;             } };
      template <typename base> struct post_increment    <decltype(static_cast<void>(instanceof<base>()++)),             base> final { static bool const value = true; constexpr static decltype(std::declval<base>()++)             valueof(base&& operand) noexcept(noexcept(instanceof<base>()++))             { return std::forward<base>(operand)++;             } };
      template <typename base> struct pre_decrement     <decltype(static_cast<void>(--instanceof<base>())),             base> final { static bool const value = true; constexpr static decltype(--std::declval<base>())             valueof(base&& operand) noexcept(noexcept(--instanceof<base>()))             { return --std::forward<base>(operand);             } };
      template <typename base> struct pre_increment     <decltype(static_cast<void>(++instanceof<base>())),             base> final { static bool const value = true; constexpr static decltype(++std::declval<base>())             valueof(base&& operand) noexcept(noexcept(++instanceof<base>()))             { return ++std::forward<base>(operand);             } };
      template <typename base> struct self              <void,                                                          base> final { static bool const value = true; constexpr static decltype(std::declval<base>())               valueof(base&& operand) noexcept                                             { return std::forward<base>(operand);               } };

      template <typename baseA, typename baseB> struct add                  <decltype(static_cast<void>(instanceof<baseA>()   + instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   + std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   + instanceof<baseB>())) { return (std::forward<baseA>(operandA)   + std::forward<baseB>(operandB)); } };
      ...
      template <typename baseA, typename baseB> struct assign_add           <decltype(static_cast<void>(instanceof<baseA>()  += instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  += std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  += instanceof<baseB>())) { return (std::forward<baseA>(operandA)  += std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_bitwise_and   <decltype(static_cast<void>(instanceof<baseA>()  &= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  &= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  &= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  &= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_bitwise_or    <decltype(static_cast<void>(instanceof<baseA>()  |= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  |= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  |= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  |= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_bitwise_xor   <decltype(static_cast<void>(instanceof<baseA>()  ^= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  ^= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  ^= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  ^= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_divide        <decltype(static_cast<void>(instanceof<baseA>()  /= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  /= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  /= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  /= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_left_shift    <decltype(static_cast<void>(instanceof<baseA>() <<= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>() <<= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>() <<= instanceof<baseB>())) { return (std::forward<baseA>(operandA) <<= std::forward<baseB>(operandB)); } };
      ...
      template <typename baseA, typename baseB> struct assign_multiply      <decltype(static_cast<void>(instanceof<baseA>()  *= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  *= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  *= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  *= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_right_shift   <decltype(static_cast<void>(instanceof<baseA>() >>= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>() >>= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>() >>= instanceof<baseB>())) { return (std::forward<baseA>(operandA) >>= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct assign_subtract      <decltype(static_cast<void>(instanceof<baseA>()  -= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  -= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  -= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  -= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct bitwise_and          <decltype(static_cast<void>(instanceof<baseA>()   & instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   & std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   & instanceof<baseB>())) { return (std::forward<baseA>(operandA)   & std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct bitwise_or           <decltype(static_cast<void>(instanceof<baseA>()   | instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   | std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   | instanceof<baseB>())) { return (std::forward<baseA>(operandA)   | std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct bitwise_xor          <decltype(static_cast<void>(instanceof<baseA>()   ^ instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   ^ std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   ^ instanceof<baseB>())) { return (std::forward<baseA>(operandA)   ^ std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct boolean_and          <decltype(static_cast<void>(instanceof<baseA>()  && instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  && std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  && instanceof<baseB>())) { return (std::forward<baseA>(operandA)  && std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct boolean_or           <decltype(static_cast<void>(instanceof<baseA>()  || instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  || std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  || instanceof<baseB>())) { return (std::forward<baseA>(operandA)  || std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct cast                 <decltype(static_cast<void>((baseB) instanceof<baseA>())),                 baseA, baseB> final { static bool const value = true; constexpr static decltype((baseB) std::declval<baseA>())                     valueof(baseA&& operand)                    noexcept(noexcept((baseB) instanceof<baseA>()))                 { return (baseB) std::forward<baseA>(operand);                              } };
      template <typename baseA, typename baseB> struct comma                <decltype(static_cast<void>(instanceof<baseA>()   , instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   , std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   , instanceof<baseB>())) { return (std::forward<baseA>(operandA)   , std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct divide               <decltype(static_cast<void>(instanceof<baseA>()   / instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   / std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   / instanceof<baseB>())) { return (std::forward<baseA>(operandA)   / std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct equals               <decltype(static_cast<void>(instanceof<baseA>()  == instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  == std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  == instanceof<baseB>())) { return (std::forward<baseA>(operandA)  == std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct equals_greater       <decltype(static_cast<void>(instanceof<baseA>()  >= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  >= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  >= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  >= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct equals_lesser        <decltype(static_cast<void>(instanceof<baseA>()  <= instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  <= std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  <= instanceof<baseB>())) { return (std::forward<baseA>(operandA)  <= std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct greater              <decltype(static_cast<void>(instanceof<baseA>()   > instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   > std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   > instanceof<baseB>())) { return (std::forward<baseA>(operandA)   > std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct left_shift           <decltype(static_cast<void>(instanceof<baseA>()  << instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  << std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  << instanceof<baseB>())) { return (std::forward<baseA>(operandA)  << std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct lesser               <decltype(static_cast<void>(instanceof<baseA>()   < instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   < std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   < instanceof<baseB>())) { return (std::forward<baseA>(operandA)   < std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct member_pointer_access<decltype(static_cast<void>(instanceof<baseA>() ->* instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>() ->* std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>() ->* instanceof<baseB>())) { return (std::forward<baseA>(operandA) ->* std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct modulo               <decltype(static_cast<void>(instanceof<baseA>()   % instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   % std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   % instanceof<baseB>())) { return (std::forward<baseA>(operandA)   % std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct multiply             <decltype(static_cast<void>(instanceof<baseA>()   * instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   * std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   * instanceof<baseB>())) { return (std::forward<baseA>(operandA)   * std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct right_shift          <decltype(static_cast<void>(instanceof<baseA>()  >> instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  >> std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  >> instanceof<baseB>())) { return (std::forward<baseA>(operandA)  >> std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct subscript            <decltype(static_cast<void>(instanceof<baseA>()[instanceof<baseB>()])),    baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()[std::declval<baseB>()]))    valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()[instanceof<baseB>()]))    { return (std::forward<baseA>(operandA)[std::forward<baseB>(operandB)]);    } };
      template <typename baseA, typename baseB> struct subtract             <decltype(static_cast<void>(instanceof<baseA>()   - instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()   - std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()   - instanceof<baseB>())) { return (std::forward<baseA>(operandA)   - std::forward<baseB>(operandB)); } };
      template <typename baseA, typename baseB> struct unequal              <decltype(static_cast<void>(instanceof<baseA>()  != instanceof<baseB>())), baseA, baseB> final { static bool const value = true; constexpr static decltype((std::declval<baseA>()  != std::declval<baseB>())) valueof(baseA&& operandA, baseB&& operandB) noexcept(noexcept(instanceof<baseA>()  != instanceof<baseB>())) { return (std::forward<baseA>(operandA)  != std::forward<baseB>(operandB)); } };
      ...
      template <typename base, typename... bases> struct construct <decltype(static_cast<void>(base(instanceof<bases>()...))),               base, bases...> final { static bool const value = true; constexpr static base                                                     valueof(bases&&... operands)                 noexcept(noexcept(base(instanceof<bases>()...)))               { return base(std::forward<bases>(operands)...);                        } };
      template <typename base, typename... bases> struct initialize<decltype(static_cast<void>(base{instanceof<bases>()...})),               base, bases...> final { static bool const value = true; constexpr static base                                                     valueof(bases&&... operands)                 noexcept(noexcept(base{instanceof<bases>()...}))               { return {std::forward<bases>(operands)...};                            } };
    };
    ...
    struct operation_value final {
      ...
      private:
        ...
        struct qualifier final {
          ...
          // ... ->> Generate `collection` of type qualifiers from specified `base`
        ...
        struct variant<base, bases...> final {
          ...
          struct member {
            ...
            constexpr member(type&& value) noexcept(noexcept((decltype(member::value)) std::declval<type>())) :
              value((decltype(member::value)) std::forward<type>(value))
            {}
          };
          ...
          struct member<subbase, typename std::enable_if<operation_information::construct<void, subbase, subbase>::value, void>::type> final : public member<subbase, std::nullptr_t> {
            ...
            constexpr member(type&& value) noexcept(noexcept((decltype(member::value)) std::declval<type>()) && noexcept(decltype(member::value)(instanceof<decltype(member::value)>()))) :
              member<subbase, std::nullptr_t>::member(std::forward<type>(value))
            {}
          };
      ...
      private:
        ...
        template <typename type, qualifier::type... baseQualifiers, typename std::enable_if<false != operation_information::construct<void, decltype(operation_value::value), type&&>::value, std::nullptr_t>::type = nullptr>
        ...
        template <typename type, typename std::enable_if<false != (std::is_reference<type>::value || operation_information::construct<void, decltype(operation_value::value), type&&>::value), std::nullptr_t>::type = nullptr>
      ...
      public:
        template <typename type, typename std::enable_if<std::is_lvalue_reference<type>::value && false != operation_information::overloaded_address<void, type&&>::value, std::nullptr_t>::type = nullptr>
        ...
        template <typename type, typename std::enable_if<false == std::is_reference<type>::value && false != operation_information::construct<void, decltype(operation_value::value), type&&>::value, std::nullptr_t>::type = nullptr>
        constexpr operation_value(type&& value) noexcept :
        ...
        template <typename type, typename std::enable_if<false == std::is_reference<type>::value && false == operation_information::construct<void, decltype(operation_value::value), type&&>::value, std::nullptr_t>::type = nullptr>
        constexpr /* inline */ operation_value(type&& value) noexcept :
          operation_value::operation_value(std::forward<type>(value), NULL/*(allocation<typename std::remove_cv<type>::type>::value = std::forward<type>(value))*/, typeid(type), sizeof(type), alignof(type), typename qualifier::collection_from<typename std::remove_reference<type>::type>::type{})
        {}
  ...
  private:
    ...
    template <class information, unsigned char arity>
...
//   // ...
//   static unsigned char const QUALIFIER_MAX = 12u; // 12 < x < 256
