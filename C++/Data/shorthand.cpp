...
struct $shorthand {
  protected:
    ...
    template <std::size_t arity, $$ state, bool... states, typename base, typename... bases> struct cast<$n<arity, state, states...>, base (bases...)      noexcept> { static std::size_t const adicity = sizeof...(bases); constexpr static base value(bases... arguments)      noexcept { return static_cast<base>($n<arity, $c>{}.operator ()(static_cast<bases>(arguments)...)); } };
    template <std::size_t arity, $$ state, bool... states, typename base, typename... bases> struct cast<$n<arity, state, states...>, base (bases..., ...) noexcept> { static std::size_t const adicity = sizeof...(bases); constexpr static base value(bases... arguments, ...) noexcept { return static_cast<base>($n<arity, $c>{}.operator ()(static_cast<bases>(arguments)...)); } };

    #ifdef __cpp_noexcept_function_type
      template <class shorthand, typename base, typename... bases> struct cast<shorthand, base (bases...)>      : public cast<shorthand, base (bases...)      noexcept> {};
      template <class shorthand, typename base, typename... bases> struct cast<shorthand, base (bases..., ...)> : public cast<shorthand, base (bases..., ...) noexcept> {};
    #endif
    ...
    template <std::size_t arity, $$ state, bool... states> struct is_shorthand<$n<arity, state, states...> >     final { static bool const value = true; };
    ...
    struct value final {
      ...
      #endif
      #ifdef __cpp_lib_byte
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::byte const value) noexcept(noexcept(std::byte(instanceof<std::byte>()))) : std_byte(value), metadata(NULL /* --> &typeid(std::byte) */), type(static_cast<enum type>($shorthand::standard::byte)) {}
      #endif
      #ifdef __cpp_lib_endian
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::endian const value) noexcept(noexcept(std::endian(instanceof<std::endian>()))) : std_endian(value), metadata(NULL /* --> &typeid(std::endian) */), type(static_cast<enum type>($shorthand::standard::endian)) {}
      #endif
      #ifdef __cpp_lib_ranges
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::ranges::dangling      const value) noexcept(noexcept(std::ranges::dangling     (instanceof<std::ranges::dangling>     ()))) : std_dangling     (value), metadata(NULL /* --> &typeid(std::ranges::dangling) */),      type(static_cast<enum type>($shorthand::standard::dangling))      {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::ranges::subrange_kind const value) noexcept(noexcept(std::ranges::subrange_kind(instanceof<std::ranges::subrange_kind>()))) : std_subrange_kind(value), metadata(NULL /* --> &typeid(std::ranges::subrange_kind) */), type(static_cast<enum type>($shorthand::standard::subrange_kind)) {}
      #endif
      #ifdef __cpp_lib_source_location
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::source_location const value) noexcept(noexcept(std::source_location(instanceof<std::source_location>()))) : std_source_location(value), metadata(NULL /* --> &typeid(std::source_location) */), type(static_cast<enum type>($shorthand::standard::source_location)) {}
      #endif
      #ifdef __cpp_lib_three_way_comparison
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::compare_three_way const value) noexcept(noexcept(std::compare_three_way(instanceof<std::compare_three_way>()))) : std_compare_three_way(value), metadata(NULL /* --> &typeid(std::compare_three_way) */), type(static_cast<enum type>($shorthand::standard::compare_three_way)) {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::partial_ordering  const value) noexcept(noexcept(std::partial_ordering (instanceof<std::partial_ordering> ()))) : std_partial_ordering (value), metadata(NULL /* --> &typeid(std::partial_ordering) */),  type(static_cast<enum type>($shorthand::standard::partial_ordering))  {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::strong_ordering   const value) noexcept(noexcept(std::strong_ordering  (instanceof<std::strong_ordering>  ()))) : std_strong_ordering  (value), metadata(NULL /* --> &typeid(std::strong_ordering) */),   type(static_cast<enum type>($shorthand::standard::strong_ordering))   {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::weak_ordering     const value) noexcept(noexcept(std::weak_ordering    (instanceof<std::weak_ordering>    ()))) : std_weak_ordering    (value), metadata(NULL /* --> &typeid(std::weak_ordering) */),     type(static_cast<enum type>($shorthand::standard::weak_ordering))     {}
        #ifdef __cpp_lib_coroutine
          template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::coroutine_handle<void> const value) noexcept(noexcept(std::coroutine_handle<void>(instanceof<std::coroutine_handle<void> >()))) : std_coroutine_handle      (value), metadata(NULL /* --> &typeid(std::coroutine_handle) */),       type(static_cast<enum type>($shorthand::standard::coroutine_handle))       {}
          template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::noop_coroutine_handle  const value) noexcept(noexcept(std::noop_coroutine_handle (instanceof<std::noop_coroutine_handle>  ()))) : std_noop_coroutine_handle (value), metadata(NULL /* --> &typeid(std::noop_coroutine_handle) */),  type(static_cast<enum type>($shorthand::standard::noop_coroutine_handle))  {}
          template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::noop_coroutine_promise const value) noexcept(noexcept(std::noop_coroutine_promise(instanceof<std::noop_coroutine_promise> ()))) : std_noop_coroutine_promise(value), metadata(NULL /* --> &typeid(std::noop_coroutine_promise) */), type(static_cast<enum type>($shorthand::standard::noop_coroutine_promise)) {}
          template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::suspend_always         const value) noexcept(noexcept(std::suspend_always        (instanceof<std::suspend_always>         ()))) : std_suspend_always        (value), metadata(NULL /* --> &typeid(std::suspend_always) */),         type(static_cast<enum type>($shorthand::standard::suspend_always))         {}
          template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::suspend_never          const value) noexcept(noexcept(std::suspend_never         (instanceof<std::suspend_never>          ()))) : std_suspend_never         (value), metadata(NULL /* --> &typeid(std::suspend_never) */),          type(static_cast<enum type>($shorthand::standard::suspend_never))          {}
        #endif
      #endif
      #if (defined _MSVC_LANG ? _MSVC_LANG : __cplusplus) >= 201402L
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::bit_and      <void> const value) noexcept(noexcept(std::bit_and      <void>(instanceof<std::bit_and      <void> >()))) : std_bit_and      (value), metadata(NULL /* --> &typeid(std::bit_and      <void>) */), type(static_cast<enum type>($shorthand::standard::bit_and))       {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::bit_not      <>     const value) noexcept(noexcept(std::bit_not      <>    (instanceof<std::bit_not      <> >    ()))) : std_bit_not      (value), metadata(NULL /* --> &typeid(std::bit_not      <>) */),     type(static_cast<enum type>($shorthand::standard::bit_not))       {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::bit_or       <void> const value) noexcept(noexcept(std::bit_or       <void>(instanceof<std::bit_or       <void> >()))) : std_bit_or       (value), metadata(NULL /* --> &typeid(std::bit_or       <void>) */), type(static_cast<enum type>($shorthand::standard::bit_or))        {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::bit_xor      <void> const value) noexcept(noexcept(std::bit_xor      <void>(instanceof<std::bit_xor      <void> >()))) : std_bit_xor      (value), metadata(NULL /* --> &typeid(std::bit_xor      <void>) */), type(static_cast<enum type>($shorthand::standard::bit_xor))       {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::divides      <void> const value) noexcept(noexcept(std::divides      <void>(instanceof<std::divides      <void> >()))) : std_divides      (value), metadata(NULL /* --> &typeid(std::divides      <void>) */), type(static_cast<enum type>($shorthand::standard::divides))       {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::equal_to     <void> const value) noexcept(noexcept(std::equal_to     <void>(instanceof<std::equal_to     <void> >()))) : std_equal_to     (value), metadata(NULL /* --> &typeid(std::equal_to     <void>) */), type(static_cast<enum type>($shorthand::standard::equal_to))      {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::greater      <void> const value) noexcept(noexcept(std::greater      <void>(instanceof<std::greater      <void> >()))) : std_greater      (value), metadata(NULL /* --> &typeid(std::greater      <void>) */), type(static_cast<enum type>($shorthand::standard::greater))       {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::greater_equal<void> const value) noexcept(noexcept(std::greater_equal<void>(instanceof<std::greater_equal<void> >()))) : std_greater_equal(value), metadata(NULL /* --> &typeid(std::greater_equal<void>) */), type(static_cast<enum type>($shorthand::standard::greater_equal)) {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::less         <void> const value) noexcept(noexcept(std::less         <void>(instanceof<std::less         <void> >()))) : std_less         (value), metadata(NULL /* --> &typeid(std::less         <void>) */), type(static_cast<enum type>($shorthand::standard::less))          {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::less_equal   <void> const value) noexcept(noexcept(std::less_equal   <void>(instanceof<std::less_equal   <void> >()))) : std_less_equal   (value), metadata(NULL /* --> &typeid(std::less_equal   <void>) */), type(static_cast<enum type>($shorthand::standard::less_equal))    {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::logical_and  <void> const value) noexcept(noexcept(std::logical_and  <void>(instanceof<std::logical_and  <void> >()))) : std_logical_and  (value), metadata(NULL /* --> &typeid(std::logical_and  <void>) */), type(static_cast<enum type>($shorthand::standard::logical_and))   {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::logical_not  <void> const value) noexcept(noexcept(std::logical_not  <void>(instanceof<std::logical_not  <void> >()))) : std_logical_not  (value), metadata(NULL /* --> &typeid(std::logical_not  <void>) */), type(static_cast<enum type>($shorthand::standard::logical_not))   {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::logical_or   <void> const value) noexcept(noexcept(std::logical_or   <void>(instanceof<std::logical_or   <void> >()))) : std_logical_or   (value), metadata(NULL /* --> &typeid(std::logical_or   <void>) */), type(static_cast<enum type>($shorthand::standard::logical_or))    {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::minus        <void> const value) noexcept(noexcept(std::minus        <void>(instanceof<std::minus        <void> >()))) : std_minus        (value), metadata(NULL /* --> &typeid(std::minus        <void>) */), type(static_cast<enum type>($shorthand::standard::minus))         {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::modulus      <void> const value) noexcept(noexcept(std::modulus      <void>(instanceof<std::modulus      <void> >()))) : std_modulus      (value), metadata(NULL /* --> &typeid(std::modulus      <void>) */), type(static_cast<enum type>($shorthand::standard::modulus))       {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::multiplies   <void> const value) noexcept(noexcept(std::multiplies   <void>(instanceof<std::multiplies   <void> >()))) : std_multiplies   (value), metadata(NULL /* --> &typeid(std::multiplies   <void>) */), type(static_cast<enum type>($shorthand::standard::multiplies))    {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::negate       <void> const value) noexcept(noexcept(std::negate       <void>(instanceof<std::negate       <void> >()))) : std_negate       (value), metadata(NULL /* --> &typeid(std::negate       <void>) */), type(static_cast<enum type>($shorthand::standard::negate))        {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::not_equal_to <void> const value) noexcept(noexcept(std::not_equal_to <void>(instanceof<std::not_equal_to <void> >()))) : std_not_equal_to (value), metadata(NULL /* --> &typeid(std::not_equal_to <void>) */), type(static_cast<enum type>($shorthand::standard::not_equal_to))  {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::plus         <void> const value) noexcept(noexcept(std::plus         <void>(instanceof<std::plus         <void> >()))) : std_plus         (value), metadata(NULL /* --> &typeid(std::plus         <void>) */), type(static_cast<enum type>($shorthand::standard::plus))          {}
      #endif
      #if (defined _MSVC_LANG ? _MSVC_LANG : __cplusplus) >= 201703L
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::in_place_t const value) noexcept(noexcept(std::in_place_t(instanceof<std::in_place_t>()))) : std_in_place_t(value), metadata(NULL /* --> &typeid(std::in_place_t) */), type(static_cast<enum type>($shorthand::standard::in_place_t)) {}
      #endif
      #if (defined _MSVC_LANG ? _MSVC_LANG : __cplusplus) >= 202002L
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::contiguous_iterator_tag const value) noexcept(noexcept(std::contiguous_iterator_tag(instanceof<std::contiguous_iterator_tag>()))) : std_contiguous_iterator_tag(value), metadata(NULL /* --> &typeid(std::contiguous_iterator_tag) */), type(static_cast<enum type>($shorthand::standard::contiguous_iterator_tag)) {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::default_sentinel_t      const value) noexcept(noexcept(std::default_sentinel_t     (instanceof<std::default_sentinel_t>     ()))) : std_default_sentinel_t     (value), metadata(NULL /* --> &typeid(std::default_sentinel_t) */),      type(static_cast<enum type>($shorthand::standard::default_sentinel_t))      {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::destroying_delete_t     const value) noexcept(noexcept(std::destroying_delete_t    (instanceof<std::destroying_delete_t>    ()))) : std_destroying_delete_t    (value), metadata(NULL /* --> &typeid(std::destroying_delete_t) */),     type(static_cast<enum type>($shorthand::standard::destroying_delete_t))     {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::identity                const value) noexcept(noexcept(std::identity               (instanceof<std::identity>               ()))) : std_identity               (value), metadata(NULL /* --> &typeid(std::identity) */),                type(static_cast<enum type>($shorthand::standard::identity))                {}
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::unreachable_sentinel_t  const value) noexcept(noexcept(std::unreachable_sentinel_t (instanceof<std::unreachable_sentinel_t> ()))) : std_unreachable_sentinel_t (value), metadata(NULL /* --> &typeid(std::unreachable_sentinel_t)  */), type(static_cast<enum type>($shorthand::standard::unreachable_sentinel_t))  {}
      #endif
      #if (defined _MSVC_LANG ? _MSVC_LANG : __cplusplus) <= 202002L // --> < 2023..L
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::pointer_safety const value) noexcept(noexcept(std::pointer_safety(instanceof<std::pointer_safety>()))) : std_pointer_safety(value), metadata(NULL /* --> &typeid(std::pointer_safety) */), type(static_cast<enum type>($shorthand::standard::pointer_safety)) {}
      #endif
      #if defined __STDCPP_BFLOAT16_T__
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::bfloat16_t const value) noexcept(noexcept(std::bfloat16_t(instanceof<std::bfloat16_t>()))) : std_bfloat16_t(value), metadata(NULL /* --> &typeid(std::bfloat16_t) */), type(static_cast<enum type>($shorthand::standard::bfloat16_t)) {}
      #endif
      #if defined __STDCPP_FLOAT16_T__
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::float16_t const value) noexcept(noexcept(std::float16_t(instanceof<std::float16_t>()))) : std_float16_t(value), metadata(NULL /* --> &typeid(std::float16_t) */), type(static_cast<enum type>($shorthand::standard::float16_t)) {}
      #endif
      #if defined __STDCPP_FLOAT32_T__
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::float32_t const value) noexcept(noexcept(std::float32_t(instanceof<std::float32_t>()))) : std_float32_t(value), metadata(NULL /* --> &typeid(std::float32_t) */), type(static_cast<enum type>($shorthand::standard::float32_t)) {}
      #endif
      #if defined __STDCPP_FLOAT64_T__
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::float64_t const value) noexcept(noexcept(std::float64_t(instanceof<std::float64_t>()))) : std_float64_t(value), metadata(NULL /* --> &typeid(std::float64_t) */), type(static_cast<enum type>($shorthand::standard::float64_t)) {}
      #endif
      #if defined __STDCPP_FLOAT128_T__
        template <std::size_t arity> constexpr value(constant<arity> const, struct standard const value::* const, std::float128_t const value) noexcept(noexcept(std::float128_t(instanceof<std::float128_t>()))) : std_float128_t(value), metadata(NULL /* --> &typeid(std::float128_t) */), type(static_cast<enum type>($shorthand::standard::float128_t)) {}
      #endif
      template <std::size_t arity, typename typed> constexpr value(constant<arity> const, enum enumeration const value::* const, typed const value) noexcept : enumeration(static_cast<enum enumeration>(value)), metadata(&typeid(typed)),                      type($shorthand::enumeration) {}
      template <std::size_t arity, typename typed> constexpr value(constant<arity> const, sfinaeptr_t      const value::* const, typed&&)           noexcept : null       (sfinaeptr),                            metadata(NULL /* --> &typeid(sfinaeptr_t) */), type($shorthand::null)        { static_assert(0u == arity, "Shorthand can not accept arguments or too few arguments passed to shorthand"); }

      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_bool          const& value) noexcept(noexcept(std::atomic_bool         (instanceof<std::atomic_bool          const&>().load()))) : std_atomic_bool         {0x00u}, metadata(&typeid(std::atomic_bool)),          type(static_cast<enum type>($shorthand::standard::atomic_bool))          { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_bool)]>         (this -> std_atomic_bool))          std::atomic_bool         (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_char          const& value) noexcept(noexcept(std::atomic_char         (instanceof<std::atomic_char          const&>().load()))) : std_atomic_char         {0x00u}, metadata(&typeid(std::atomic_char)),          type(static_cast<enum type>($shorthand::standard::atomic_char))          { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_char)]>         (this -> std_atomic_char))          std::atomic_char         (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_int           const& value) noexcept(noexcept(std::atomic_int          (instanceof<std::atomic_int           const&>().load()))) : std_atomic_int          {0x00u}, metadata(&typeid(std::atomic_int)),           type(static_cast<enum type>($shorthand::standard::atomic_int))           { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_int)]>          (this -> std_atomic_int))           std::atomic_int          (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_llong         const& value) noexcept(noexcept(std::atomic_llong        (instanceof<std::atomic_llong         const&>().load()))) : std_atomic_llong        {0x00u}, metadata(&typeid(std::atomic_llong)),         type(static_cast<enum type>($shorthand::standard::atomic_llong))         { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_llong)]>        (this -> std_atomic_llong))         std::atomic_llong        (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_long          const& value) noexcept(noexcept(std::atomic_long         (instanceof<std::atomic_long          const&>().load()))) : std_atomic_long         {0x00u}, metadata(&typeid(std::atomic_long)),          type(static_cast<enum type>($shorthand::standard::atomic_long))          { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_long)]>         (this -> std_atomic_long))          std::atomic_long         (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_schar         const& value) noexcept(noexcept(std::atomic_schar        (instanceof<std::atomic_schar         const&>().load()))) : std_atomic_schar        {0x00u}, metadata(&typeid(std::atomic_schar)),         type(static_cast<enum type>($shorthand::standard::atomic_schar))         { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_schar)]>        (this -> std_atomic_schar))         std::atomic_schar        (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_short         const& value) noexcept(noexcept(std::atomic_short        (instanceof<std::atomic_short         const&>().load()))) : std_atomic_short        {0x00u}, metadata(&typeid(std::atomic_short)),         type(static_cast<enum type>($shorthand::standard::atomic_short))         { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_short)]>        (this -> std_atomic_short))         std::atomic_short        (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_uchar         const& value) noexcept(noexcept(std::atomic_uchar        (instanceof<std::atomic_uchar         const&>().load()))) : std_atomic_uchar        {0x00u}, metadata(&typeid(std::atomic_uchar)),         type(static_cast<enum type>($shorthand::standard::atomic_uchar))         { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_uchar)]>        (this -> std_atomic_uchar))         std::atomic_uchar        (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_uint          const& value) noexcept(noexcept(std::atomic_uint         (instanceof<std::atomic_uint          const&>().load()))) : std_atomic_uint         {0x00u}, metadata(&typeid(std::atomic_uint)),          type(static_cast<enum type>($shorthand::standard::atomic_uint))          { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_uint)]>         (this -> std_atomic_uint))          std::atomic_uint         (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_ullong        const& value) noexcept(noexcept(std::atomic_ullong       (instanceof<std::atomic_ullong        const&>().load()))) : std_atomic_ullong       {0x00u}, metadata(&typeid(std::atomic_ullong)),        type(static_cast<enum type>($shorthand::standard::atomic_ullong))        { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_ullong)]>       (this -> std_atomic_ullong))        std::atomic_ullong       (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_ulong         const& value) noexcept(noexcept(std::atomic_ulong        (instanceof<std::atomic_ulong         const&>().load()))) : std_atomic_ulong        {0x00u}, metadata(&typeid(std::atomic_ulong)),         type(static_cast<enum type>($shorthand::standard::atomic_ulong))         { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_ulong)]>        (this -> std_atomic_ulong))         std::atomic_ulong        (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_ushort        const& value) noexcept(noexcept(std::atomic_ushort       (instanceof<std::atomic_ushort        const&>().load()))) : std_atomic_ushort       {0x00u}, metadata(&typeid(std::atomic_ushort)),        type(static_cast<enum type>($shorthand::standard::atomic_ushort))        { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_ushort)]>       (this -> std_atomic_ushort))        std::atomic_ushort       (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_wchar_t       const& value) noexcept(noexcept(std::atomic_wchar_t      (instanceof<std::atomic_wchar_t       const&>().load()))) : std_atomic_wchar_t      {0x00u}, metadata(&typeid(std::atomic_wchar_t)),       type(static_cast<enum type>($shorthand::standard::atomic_wchar_t))       { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_wchar_t)]>      (this -> std_atomic_wchar_t))       std::atomic_wchar_t      (value.load()); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::bad_alloc            const& value) noexcept(noexcept(std::bad_alloc           (instanceof<std::bad_alloc            const&>())))        : std_bad_alloc           {0x00u}, metadata(&typeid(std::bad_alloc)),            type(static_cast<enum type>($shorthand::standard::bad_alloc))            { (void) ::new (const_cast<unsigned char (&)[sizeof(std::bad_alloc)]>           (this -> std_bad_alloc))            std::bad_alloc           (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::bad_array_new_length const& value) noexcept(noexcept(std::bad_array_new_length(instanceof<std::bad_array_new_length const&>())))        : std_bad_array_new_length{0x00u}, metadata(&typeid(std::bad_array_new_length)), type(static_cast<enum type>($shorthand::standard::bad_array_new_length)) { (void) ::new (const_cast<unsigned char (&)[sizeof(std::bad_array_new_length)]>(this -> std_bad_array_new_length)) std::bad_array_new_length(value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::bad_exception        const& value) noexcept(noexcept(std::bad_exception       (instanceof<std::bad_exception        const&>())))        : std_bad_exception       {0x00u}, metadata(&typeid(std::bad_exception)),        type(static_cast<enum type>($shorthand::standard::bad_exception))        { (void) ::new (const_cast<unsigned char (&)[sizeof(std::bad_exception)]>       (this -> std_bad_exception))        std::bad_exception       (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::bad_function_call    const& value) noexcept(noexcept(std::bad_function_call   (instanceof<std::bad_function_call    const&>())))        : std_bad_function_call   {0x00u}, metadata(&typeid(std::bad_function_call)),    type(static_cast<enum type>($shorthand::standard::bad_function_call))    { (void) ::new (const_cast<unsigned char (&)[sizeof(std::bad_function_call)]>   (this -> std_bad_function_call))    std::bad_function_call   (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::bad_typeid           const& value) noexcept(noexcept(std::bad_typeid          (instanceof<std::bad_typeid           const&>())))        : std_bad_typeid          {0x00u}, metadata(&typeid(std::bad_typeid)),           type(static_cast<enum type>($shorthand::standard::bad_typeid))           { (void) ::new (const_cast<unsigned char (&)[sizeof(std::bad_typeid)]>          (this -> std_bad_typeid))           std::bad_typeid          (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::bad_weak_ptr         const& value) noexcept(noexcept(std::bad_weak_ptr        (instanceof<std::bad_weak_ptr         const&>())))        : std_bad_weak_ptr        {0x00u}, metadata(&typeid(std::bad_weak_ptr)),         type(static_cast<enum type>($shorthand::standard::bad_weak_ptr))         { (void) ::new (const_cast<unsigned char (&)[sizeof(std::bad_weak_ptr)]>        (this -> std_bad_weak_ptr))         std::bad_weak_ptr        (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::exception            const& value) noexcept(noexcept(std::exception           (instanceof<std::exception            const&>())))        : std_exception           {0x00u}, metadata(&typeid(std::exception)),            type(static_cast<enum type>($shorthand::standard::exception))            { (void) ::new (const_cast<unsigned char (&)[sizeof(std::exception)]>           (this -> std_exception))            std::exception           (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::exception_ptr        const  value) noexcept(noexcept(std::exception_ptr       (instanceof<std::exception_ptr>              ())))        : std_exception_ptr       {0x00u}, metadata(&typeid(std::exception_ptr)),        type(static_cast<enum type>($shorthand::standard::exception_ptr))        { (void) ::new (const_cast<unsigned char (&)[sizeof(std::exception_ptr)]>       (this -> std_exception_ptr))        std::exception_ptr       (value); }
      template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::nested_exception     const& value) noexcept(noexcept(std::nested_exception    (instanceof<std::nested_exception     const&>())))        : std_nested_exception    {0x00u}, metadata(&typeid(std::nested_exception)),     type(static_cast<enum type>($shorthand::standard::nested_exception))     { (void) ::new (const_cast<unsigned char (&)[sizeof(std::nested_exception)]>    (this -> std_nested_exception))     std::nested_exception    (value); }
      #ifdef __cpp_char8_t
        template <std::size_t arity> inline value(constant<arity> const, struct standard const value::* const, std::atomic_char8_t const& value) noexcept(noexcept(std::atomic_char8_t(instanceof<std::atomic_char8_t const&>().load()))) : std_atomic_char8_t{0x00u}, metadata(&typeid(std::atomic_char8_t)), type(static_cast<enum type>($shorthand::standard::atomic_char8_t)) { (void) ::new (const_cast<unsigned char (&)[sizeof(std::atomic_char8_t)]>(this -> std_atomic_char8_t)) std::atomic_char8_t(value.load()); }
      #endif
      #ifdef __cpp_unicode_characters
      ...
      constexpr value(constant<arityA> const, $$ value::* const, $n<arityB, state, $$c, true> const& shorthand) noexcept(noexcept(value(instanceof<value const&>()))) :
...
struct $n : public $shorthand {
  ...
  constexpr operator type() const noexcept {
    ...
    static_assert(arity <= cast<$n, typename remove_pointer<typename remove_qualifiers<type>::type>::type>::adicity, "Can not convert shorthand to given function type");

    return cast<$n, typename remove_pointer<typename remove_qualifiers<type>::type>::type>::value;
  }
};
...
struct $n<arity, state, $$c, true /* --> $$o */> : public $n<arity, state, $$c, false>, public $shorthand {
  ...
  private:
    template <typename base, typename subbase = typename remove_qualifiers<base>::type, enum $shorthand::type = (
    ...
    // template <> struct cast<void,                void> final { constexpr static sfinaeptr_t value($shorthand::value const&) noexcept { return sfinaeptr; } };
    // template <> struct cast<void const,          void> final { constexpr static sfinaeptr_t value($shorthand::value const&) noexcept { return sfinaeptr; } };
    // template <> struct cast<void const volatile, void> final { constexpr static sfinaeptr_t value($shorthand::value const&) noexcept { return sfinaeptr; } };
    // template <> struct cast<void       volatile, void> final { constexpr static sfinaeptr_t value($shorthand::value const&) noexcept { return sfinaeptr; } };
    ...
    struct cast<base, valueof<base, subbase, $shorthand::decimal> > final {
    ...
    template <typename base, typename subbase>
    struct cast<base, valueof<base, subbase, $shorthand::enumeration> > final {
      constexpr static base value($shorthand::value const& value) noexcept {
        return
          value.type == $shorthand::enumeration                               ? static_cast<base>(value.enumeration)      :
          value.type == $shorthand::integer                                   ? static_cast<base>(value.integer)          :
    ...
    template <typename base, typename subbase>
    struct cast<base, valueof<base, subbase, $shorthand::integer> > final {
      constexpr static base value($shorthand::value const& value) noexcept {
        return
          value.type == $shorthand::decimal                                     ? static_cast<base>(value.decimal)                                                                                       :
          value.type == $shorthand::enumeration                                 ? static_cast<base>(value.enumeration)                                                                                   :
    ...
    template <typename base, typename subbase> struct cast<base, valueof<base, subbase, $shorthand::null> >      final { constexpr static base value($shorthand::value const& value) noexcept { static_assert(0u == sizeof(base), "Can not convert shorthand"); return value.type == $shorthand::null ? (base) value.null : nocast<base>::value(); } };
    ...
    template <typename base, typename subbase> struct cast<base, valueof<base, subbase, $shorthand::shorthand> > final { constexpr static base value($shorthand::value const&)       noexcept { static_assert(0u == sizeof(base), "Can not convert shorthand"); return nocast<base>::value(); } };
    ...
    template <typename base, $$ substate, bool $$$c>                       struct cast<base, valueof<base, $n<0u,       substate, $$$c, true>, $shorthand::shorthand> > final { constexpr static base value($shorthand::value const&)       noexcept { return {}; } };
    template <typename base, std::size_t subarity, $$ substate, bool $$$c> struct cast<base, valueof<base, $n<subarity, substate, $$$c, true>, $shorthand::shorthand> > final { constexpr static base value($shorthand::value const& value) noexcept { return {value}; } };
  ...
  public:
    ...
    constexpr operator type() const volatile noexcept {
      ...
      return static_cast<type>(cast<type>::value(const_cast<$shorthand::value const&>(this -> value)));
    }
};
...
struct $n<arity, state, false /* --> $$c */, true /* --> $$o */> : public $n<arity, state, true, true>, public $shorthand {
  ...
  inline ~$n() noexcept {
    switch (static_cast<unsigned char>(static_cast<$n<arity, state, true, true>*>(this) -> value.type)) {
      case $shorthand::standard::atomic_bool         : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_bool;                                                                                                        break;
      case $shorthand::standard::atomic_char         : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_char;                                                                                                        break;
      case $shorthand::standard::atomic_int          : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_int;                                                                                                         break;
      case $shorthand::standard::atomic_llong        : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_llong;                                                                                                       break;
      case $shorthand::standard::atomic_long         : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_long;                                                                                                        break;
      case $shorthand::standard::atomic_schar        : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_schar;                                                                                                       break;
      case $shorthand::standard::atomic_short        : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_short;                                                                                                       break;
      case $shorthand::standard::atomic_uchar        : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_uchar;                                                                                                       break;
      case $shorthand::standard::atomic_uint         : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_uint;                                                                                                        break;
      case $shorthand::standard::atomic_ullong       : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_ullong;                                                                                                      break;
      case $shorthand::standard::atomic_ulong        : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_ulong;                                                                                                       break;
      case $shorthand::standard::atomic_ushort       : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_ushort;                                                                                                      break;
      case $shorthand::standard::atomic_wchar_t      : (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_wchar_t;                                                                                                     break;
      case $shorthand::standard::bad_alloc           : reinterpret_cast<std::bad_alloc*>           (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_bad_alloc))            -> ~bad_alloc           (); break;
      case $shorthand::standard::bad_array_new_length: reinterpret_cast<std::bad_array_new_length*>(const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_bad_array_new_length)) -> ~bad_array_new_length(); break;
      case $shorthand::standard::bad_exception       : reinterpret_cast<std::bad_exception*>       (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_bad_exception))        -> ~bad_exception       (); break;
      case $shorthand::standard::bad_function_call   : reinterpret_cast<std::bad_function_call*>   (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_bad_function_call))    -> ~bad_function_call   (); break;
      case $shorthand::standard::bad_typeid          : reinterpret_cast<std::bad_typeid*>          (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_bad_typeid))           -> ~bad_typeid          (); break;
      case $shorthand::standard::bad_weak_ptr        : reinterpret_cast<std::bad_weak_ptr*>        (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_bad_weak_ptr))         -> ~bad_weak_ptr        (); break;
      case $shorthand::standard::exception           : reinterpret_cast<std::exception*>           (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_exception))            -> ~exception           (); break;
      case $shorthand::standard::exception_ptr       : reinterpret_cast<std::exception_ptr*>       (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_exception_ptr))        -> ~exception_ptr       (); break;
      case $shorthand::standard::nested_exception    : reinterpret_cast<std::nested_exception*>    (const_cast<unsigned char*>(static_cast<$n<arity, state, true, true>*>(this) -> value.std_nested_exception))     -> ~nested_exception    (); break;
      #ifdef __cpp_char8_t
        case $shorthand::standard::atomic_char8_t: (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_char8_t; break;
      #endif
      #ifdef __cpp_unicode_characters
        case $shorthand::standard::atomic_char16_t: (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_char16_t; break;
        case $shorthand::standard::atomic_char32_t: (void) static_cast<$n<arity, state, true, true>*>(this) -> value.std_atomic_char32_t; break;
      #endif
      case $shorthand::undefined: (void) static_cast<$n<arity, state, true, true>*>(this) -> value.undefined; break;
    }
  }
};
