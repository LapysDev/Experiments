...
// ...
template <int...> union count_nontype_trait;
template <> union count_nontype_trait { enum { value = 0u }; };
template <int integer, int... integers> union count_nontype_trait<integer, integers...> { enum { value = 1u + count_nontype_trait<integers...>::value }; };

// ...
template <typename...> union count_type_trait;
template <> union count_type_trait { enum { value = 0u }; };
template <typename type, typename... types> union count_type_trait<type, types...> { enum { value = 1u + count_type_trait<types...>::value }; };
