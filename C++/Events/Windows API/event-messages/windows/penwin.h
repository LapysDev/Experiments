...
// Get/SetPenMiscInfo:
// PMI_RCCHANGE is for WM_GLOBALRCCHANGE compatibility only:
...
typedef struct tagINTERVAL      // 2.0 interval structure for inksets
    {
    ABSTIME atBegin;            // beginning of 1-ms granularity interval
...
typedef struct tagSYG           // 1.0 Symbol Graph
   ...
   LPSYC lpsyc;                 // ptr to correspond symbol ink
