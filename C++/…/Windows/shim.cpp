...
# ifndef RB_GETBANDBORDERS // ->> Returns as an Additional Message Parameter the amount of edges added to band a Message Parameter as an `LPRECT` pointer.
...
# ifndef RB_GETBKCOLOR // ->> Defaults to `CLR_NONE`.
...
# ifndef RB_GETTEXTCOLOR // ->> Defaults to `0x00000000`
...
# ifndef RB_IDTOINDEX // ->> The Message Parameter is an ID.
...
# ifndef RB_SETBKCOLOR // ->> Sets the default background color.
...
# ifndef RB_SHOWBAND // ->> Hide or show band.
#   define RB_SHOWBAND (WM_USER + 35)
# endif

# ifndef RB_SIZETORECT // ->> Resize the re-bar (or break bands) and such to this `RECT` structure as an Additional Message Parameter.
...
#ifndef _INC_PENWIN
# ifndef IE_DOCOMMAND // ->> Send command to Interactive Editor (I-Edit).
#   define IE_DOCOMMAND (IE_MSGFIRST + 50)
# endif

# ifndef IE_GETAPPDATA // ->> Gets the user-defined datum.
#   define IE_GETAPPDATA (IE_MSGFIRST + 34)
# endif

# ifndef IE_GETBKGND // ->> Gets the background options.
#   define IE_GETBKGND (IE_MSGFIRST + 6)
# endif

# ifndef IE_GETCOMMAND // ->> Gets user command.
#   define IE_GETCOMMAND (IE_MSGFIRST + 51)
# endif

# ifndef IE_GETCOUNT // ->> Gets count of strokes in Interactive Editor (I-Edit).
#   define IE_GETCOUNT (IE_MSGFIRST + 52)
# endif

# ifndef IE_GETDRAWOPTS // ->> Gets the ink draw options.
#   define IE_GETDRAWOPTS (IE_MSGFIRST + 36)
# endif

# ifndef IE_GETERASERTIP // ->> Gets the current eraser pen tip.
#   define IE_GETERASERTIP (IE_MSGFIRST + 4)
# endif

# ifndef IE_GETFORMAT // ->> Gets format of stroke(s).
#   define IE_GETFORMAT (IE_MSGFIRST + 38)
# endif

# ifndef IE_GETGESTURE // ->> Gets details on user gesture.
#   define IE_GETGESTURE (IE_MSGFIRST + 53)
# endif

# ifndef IE_GETGRIDORIGIN // ->> Gets background grid origin.
#   define IE_GETGRIDORIGIN (IE_MSGFIRST + 8)
# endif

# ifndef IE_GETGRIDPEN // ->> Gets background grid pen.
#   define IE_GETGRIDPEN (IE_MSGFIRST + 10)
# endif

# ifndef IE_GETGRIDSIZE // ->> Gets background grid size.
#   define IE_GETGRIDSIZE (IE_MSGFIRST + 12)
# endif

# ifndef IE_GETINK // ->> Gets ink from the control.
#   define IE_GETINK (IE_MSGFIRST + 0)
# endif

# ifndef IE_GETINKINPUT // ->> Gets the ink input option.
#   define IE_GETINKINPUT (IE_MSGFIRST + 40)
# endif

# ifndef IE_GETINKRECT // ->> Gets the rectangular boundaries of the ink.
#   define IE_GETINKRECT (IE_MSGFIRST + 16)
# endif

# ifndef IE_GETMENU // ->> Gets handle to pop-up menu.
#   define IE_GETMENU (IE_MSGFIRST + 54)
# endif

# ifndef IE_GETMODE // ->> Gets the current pen mode.
#   define IE_GETMODE (IE_MSGFIRST + 14)
# endif

# ifndef IE_GETNOTIFY // ->> Gets the notification bits.
#   define IE_GETNOTIFY (IE_MSGFIRST + 42)
# endif

# ifndef IE_GETPAINTDC // ->> Gets the device context handle for painting.
#   define IE_GETPAINTDC (IE_MSGFIRST + 55)
# endif

# ifndef IE_GETPDEVENT // ->> Gets details of last "pd" event.
#   define IE_GETPDEVENT (IE_MSGFIRST + 56)
# endif

# ifndef IE_GETPENTIP // ->> Gets the currently defined ink pen tip.
#   define IE_GETPENTIP (IE_MSGFIRST + 2)
# endif

# ifndef IE_GETRECOG // ->> Gets recognition options.
#   define IE_GETRECOG (IE_MSGFIRST + 44)
# endif

# ifndef IE_GETSECURITY // ->> Gets the security options.
#   define IE_GETSECURITY (IE_MSGFIRST + 46)
# endif

# ifndef IE_GETSEL // ->> Gets selection status of a stroke.
#   define IE_GETSEL (IE_MSGFIRST + 48)
# endif

# ifndef IE_GETSELCOUNT // ->> Gets count of selected strokes.
#   define IE_GETSELCOUNT (IE_MSGFIRST + 57)
# endif

# ifndef IE_GETSELITEMS // ->> Gets indices of all selection strokes.
#   define IE_GETSELITEMS (IE_MSGFIRST + 58)
# endif

# ifndef IE_GETSTYLE // ->> Gets Interactive Editor (I-Edit) control styles.
#   define IE_GETSTYLE (IE_MSGFIRST + 59)
# endif

# ifndef IE_MSGFIRST // ->> Gets indices of all selection strokes.
#   define IE_MSGFIRST (WM_USER + 150) /* -> 0x496 == 1174 */
# endif

# ifndef IE_SETAPPDATA // ->> Sets the user-defined data.
#   define IE_SETAPPDATA (IE_MSGFIRST + 35)
# endif

# ifndef IE_SETBKGND // ->> Sets the background options.
#   define IE_SETBKGND (IE_MSGFIRST + 7)
# endif

# ifndef IE_SETDRAWOPTS // ->> Sets the ink options.
#   define IE_SETDRAWOPTS (IE_MSGFIRST + 37)
# endif

# ifndef IE_SETERASERTIP // ->> Sets the current eraser pen tip.
#   define IE_SETERASERTIP (IE_MSGFIRST + 5)
# endif

# ifndef IE_SETFORMAT // ->> Sets format of stroke(s).
#   define IE_SETFORMAT (IE_MSGFIRST + 39)
# endif

# ifndef IE_SETGRIDORIGIN // ->> Sets the background grid origin.
#   define IE_SETGRIDORIGIN (IE_MSGFIRST + 9)
# endif

# ifndef IE_SETGRIDPEN // ->> Sets the background grid pen.
#   define IE_SETGRIDPEN (IE_MSGFIRST + 11)
# endif

# ifndef IE_SETGRIDSIZE // ->> Sets the background grid size.
#   define IE_SETGRIDSIZE (IE_MSGFIRST + 13)
# endif

# ifndef IE_SETINK // ->> Sets ink unto the control.
#   define IE_SETINK (IE_MSGFIRST + 1)
# endif

# ifndef IE_SETINKINPUT // ->> Sets the ink input option.
#   define IE_SETINKINPUT (IE_MSGFIRST + 41)
# endif

# ifndef IE_SETMODE // ->> Sets the current pen mode.
#   define IE_SETMODE (IE_MSGFIRST + 15)
# endif

# ifndef IE_SETNOTIFY // ->> Sets the notification bits.
#   define IE_SETNOTIFY (IE_MSGFIRST + 43)
# endif

# ifndef IE_SETPENTIP // ->> Sets the currently defined ink pen tip.
#   define IE_SETPENTIP (IE_MSGFIRST + 3)
# endif

# ifndef IE_SETRECOG // ->> Sets recognition options.
#   define IE_SETRECOG (IE_MSGFIRST + 45)
# endif

# ifndef IE_SETSECURITY // ->> Sets the security options.
#   define IE_SETSECURITY (IE_MSGFIRST + 47)
# endif

# ifndef IE_SETSEL // ->> Sets selection status of a stroke.
...
# ifndef MCIWNDM_NOTIFYERROR // ->> Message Parameter must be a `HWND` pointer and the Additional Message Parameter must be an error.
#   define MCIWNDM_NOTIFYERROR (WM_USER + 205)
# endif

# ifndef MCIWNDM_NOTIFYMEDIA // ->> Message Parameter must be a `HWND` pointer and the Additional Message Parameter must be a function.
#   define MCIWNDM_NOTIFYMEDIA (WM_USER + 203)
# endif

# ifndef MCIWNDM_NOTIFYMODE // ->> Message Parameter must be a `HWND` pointer and the Additional Message Parameter must be a mode.
...
# ifndef FM_GETFILESELLFNA // ->> LFN (Long-File Names) versions are odd.
#   define FM_GETFILESELLFNA (WM_USER + 0x0205)
# endif

# ifndef FM_GETFILESELLFNW // ->> LFN (Long-File Names) versions are odd.
...
# ifndef FM_GETSELCOUNTLFN // ->> LFN (Long-File Names) versions are odd.
